...
with open(log_file, 'r', encoding='utf-8') as f:
    for line in f:
        try:
            ...
            # Find the time when APK 3.76 was likely built. Let's look for any CODE_ACTION that modified DashboardTab before step 7900
            if data.get('type') == 'PLANNER_RESPONSE':
                step = data.get('step_index', 0)
                if step < 7900:  # anything before my session
